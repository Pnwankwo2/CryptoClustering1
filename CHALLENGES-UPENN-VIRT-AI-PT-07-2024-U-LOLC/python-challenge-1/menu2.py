...
selection = input("Please enter the item number: ")

# Check if the input is a valid number

    # Check if the selection is in the menu
if selection in flat_menu:
        selected_item = flat_menu[selection]
...
# item_number = int(input("Please enter a menu item number: "))
...
print("__________________________|________|________")
