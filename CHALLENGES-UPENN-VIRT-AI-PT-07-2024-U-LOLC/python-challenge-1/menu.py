...
while place_order:
    ...
    menu_items = {i: key for i, key in enumerate(menu.keys(), 1)} # Tutor help
    ...
    for i, key in menu_items.items():
        ...
        #menu_category = input(items[i] = key
    ...
    #    if int(menu_category) in menu_items.keys():
        ...
        if menu_item.isdigit():
                ...
                if menu_item in menu_items.keys():
                    ...
                    print(f"{menu_item} was not a menu item number.")
        else:
...
while True:
        ...
        match keep_ordering.lower(): #tutor help
            case "y":
                # Continue ordering
                place_order = True #Tutor help
...
for item in order_list:
    ...
    item_price = item["Price"]
    item_quantity = item["Quantity"]
num_item_spaces = 27 - len(item_name)
space_string = ' ' * num_item_spaces

    # Print the item name, price, and quantity
print(f"{item_name}{space_string}| ${item_price:.2f} | {item_quantity}")
...
#print(f"{item_name}{space_string}| ${item_price} | {item_quantity}") 
#print(f"{item_name}{space_string}| ${item['Price']} | {item['Quantity']}")
#num_item_spaces = 12 - len(key)
#item_spaces = " " * num_item_spaces
#i = 1
#print(f"{i}       | {key}{item_spaces} | ${value}")  
...
# and print the prices.sum
#total_cost = sum([item["Price"] * item["Quantity"] for item in order_list])
#print(f"Total cost: ${total_cost:.2f}") 
# 12. Print a thank you message
#print("Thank you for ordering from the variety food truck!")
